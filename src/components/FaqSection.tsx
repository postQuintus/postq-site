...
const FAQS = [
  ...
  },
  {
    ...
    a: 'Попробуйте обновить подписку и/или сменить сервер. Если проблема сохраняется — напишите в поддержку @postq_vpn_support_bot, мы быстро разберёмся в чём проблема.',
  },
]
    ...
    <section id="faq" className="faq-section" style={{ position: 'relative', zIndex: 1, scrollMarginTop: '64px' }}>
      <div className="max-w-3xl mx-auto px-6">
        ...
        >
          ...
          <a
            href="https://t.me/postq_vpn_support_bot"
            target="_blank"
